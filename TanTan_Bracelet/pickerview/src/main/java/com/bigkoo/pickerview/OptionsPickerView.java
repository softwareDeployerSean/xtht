...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private OnOptionsSmoothListener optionsSmoothListener;
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.optionsSmoothListener=builder.optionsSmoothListener;
    ...
    public static class Builder {
        ...
        //Required
        public Builder(Context context, OnOptionsSelectListener listener,OnOptionsSmoothListener smoothListener) {
            this.context = context;
            this.optionsSelectListener = listener;
            this.optionsSmoothListener=optionsSmoothListener;
        }
    ...
    public void returnData() {
        ...
        if (optionsSmoothListener!=null){
            int[] optionsCurrentItems = wheelOptions.getCurrentItems();
            optionsSmoothListener.onOptionsSmooth(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2], clickView);
        }
    ...
    public interface OnOptionsSmoothListener {
        void onOptionsSmooth(int options1, int options2, int options3, View v);
    }
