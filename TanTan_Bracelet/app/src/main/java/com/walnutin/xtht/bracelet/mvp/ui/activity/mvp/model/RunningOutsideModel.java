...
@ActivityScope
public class RunningOutsideModel extends BaseModel implements RunningOutsideContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public RunningOutsideModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
