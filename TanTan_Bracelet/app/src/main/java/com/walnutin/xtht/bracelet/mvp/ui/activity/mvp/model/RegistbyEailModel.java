...
@ActivityScope
public class RegistbyEailModel extends BaseModel implements RegistbyEailContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public RegistbyEailModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
