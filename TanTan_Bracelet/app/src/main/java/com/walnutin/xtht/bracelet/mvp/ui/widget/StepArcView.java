...
public class StepArcView extends View {
     ...
     * 2.绘制当前步数的红色圆弧
     */
    private void drawArcTop(Canvas canvas, RectF rectF) {
...
//        LinearGradient linearGradient = new LinearGradient();
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        canvas.drawText(stepString, centerX, getHeight() - bounds.height() - 3 * borderWidth + getFontHeight(numberTextSize), vTextPaint);
    }
