...
public class MessagePushModel extends BaseModel implements MessagePushContract.Model {
    ...
    @Override
    public List<MarginMenue> getMenueData() {
        List<MarginMenue> msgMenues = new ArrayList<>();

        MarginMenue menue1 = new MarginMenue(1, "Facebook", "", false, 0);
        msgMenues.add(menue1);

        MarginMenue menue2 = new MarginMenue(2, "Twitter", "", false, 0);
        msgMenues.add(menue2);

        MarginMenue menue3 = new MarginMenue(3, "QQ", "", false, 0);
        msgMenues.add(menue3);

        MarginMenue menue4 = new MarginMenue(4, "微信", "", false, 0);
        msgMenues.add(menue4);

        MarginMenue menue5 = new MarginMenue(1, "短信", "", false, 0);
        msgMenues.add(menue5);

        MarginMenue menue6 = new MarginMenue(1, "其它", "", true, 150);
